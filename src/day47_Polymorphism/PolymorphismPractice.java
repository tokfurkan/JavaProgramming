...
public class PolymorphismPractice {
    ...
    public static void main(String[] args) {
        ...
        Car[] cars = {
                ...
                new Toyota("Corolla", 2011, 32000, "White", 310000),
                new BMW("M3", 2015, 33000, "Blue", 14040),
                new BMW("M5", 2017, 35000, "Black", 15000),
                new BMW("M4", 2018, 40000, "White", 19000),
                new BMW("7 series", 2009, 30000, "Purple", 21000),
                new BMW("i3", 2011, 3000, "Black", 9000),
                new Toyota("Camry", 2018, 30000, "Red", 185000),
                new Toyota("Rav4", 2012, 23000, "Blue", 285000),
                new Toyota("Avalon", 2019, 35000, "Blue", 175320),
        ...
        //highest mileage and lowest mileage
